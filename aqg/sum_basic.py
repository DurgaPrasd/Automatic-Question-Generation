...
Ref: Nenkova A, Vanderwende L. The impact of frequency on summarization[J]. Microsoft Research, Redmond, Washington, Tech.
...
class SumBasic:
	...
	def _clean_sentences(self, sentences):
		...
		for sentence in sentences.split('.'):
			...
			sentence = [stemmer.stem(word) for word in tokenize(sentence) if not word in stop_words]
			if sentence:
	...
	def _sentence_weight(self, word_distribution, sentence_processed):
		...
		for sentence_id in sentence_processed:
			...
			sentence_weight[sentence_id] = sentence_weight[sentence_id]/float(len(sentence_processed[sentence_id]))
